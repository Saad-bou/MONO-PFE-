...
/**
 * MONO — Women's Collection Detail
 *
 * Identical structure to men's collection detail — only content differs.
 */
...
export default function WomenCollectionPage() {
  ...
  const collectionProducts = products.filter(
    (p) => p.collection === slug && p.category === 'women'
  );
          ...
          <Container size="wide">
            ...
            <div className="hero-image">
              <div className="relative w-full overflow-hidden min-h-[240px] sm:min-h-[360px]" style={{ aspectRatio: '21/9' }}>
                <Image src="/assets/story/minimal-design.webp" alt={`${collection.name} editorial campaign`} fill sizes="100vw" className="object-cover object-[50%_35%]" />
              </div>
            </div>
          </Container>
        </Section>
